    ...
    public function run()
    {
        DB::table('prodotto')->insert ([
           ['nome'=> 'CORSAIR Memoria Dimm Vengeance LPX 16GB',
            'codCat'=>4,
            'descCorta'=>"La memoria Vengeance LPX è progettata per un overclocking ad alte prestazioni. Il dissipatore di calore è realizzato in puro alluminio per una dissipazione del calore più rapida, mentre il PCB ad otto strati ti aiuta a gestire il calore e fornisce un margine di overclocking di livello ottimo. Ciascun circuito integrato è selezionato individualmente per un potenziale prestazionale. ",
            ...
            'codCat'=>4,
            'descCorta'=>"HyperX FURY DDR4 può definirsi 'cool' sia per lo stile che per l'efficacia del dissipatore di calore a basso profilo. Velocità testate al 100% e garanzia a vita contribuiscono a fare di questa memoria una soluzione di upgrade semplice e sicura per i sistemi Intel o AMD.",
            ...
            'codCat'=>4,
            'descCorta'=>"I moduli di memoria DDR4 con overclocking CORSAIR serie VENGEANCE RGB PRO illumineranno il tuo PC grazie alla sorprendente illuminazione RGB multizona, offrendo allo stesso tempo le massime prestazioni e stabilità offerte dai modelli DDR4.",
            ...
            'codCat'=>4,
            'descCorta'=>"Le memorie della Serie Patriot Viper Elite DDR4 costituiscono un mix ineguagliabile di velocità estreme e aggressività nel timing, perfetto per esaltare le prestazioni dei processori e velocizzare le attività di video editing, 3D rendering, gaming ed elaborazione AI. Questi moduli vantano un’estrema semplicità di overclocking, che non richiede operazioni di regolazione manuale del timing nel BIOS grazie ai profile XMP 2.0",
            ...
            'codCat'=>6,
            'descCorta'=>"MSI B450 GAMING PRO CARBON AC, AMD B450, S AM4, DDR4, SATA3, Dual M.2, 2-Way CrossFire, GbE/ac WiFi, USB 3.1 G2 A+C, ATX",
            ...
            'codCat'=>6,
            'descCorta'=>"Goditi l'esperienza della nuova generazione di schede madri AMD con la MPG X570 GAMING PRO CARBON WIFI in grado di portare i processori di terza generazione AMD 3000 series AM4 al massimo. Sorpassa i limiti del tuo sistema con Lightning Gen 4 e Wi-Fi 6 AX. Strumenti smart come DDR4 Boost e Core Boost, creati per mantenere le tue performance sempre al top",
            ...
            'codCat'=>6,
            'descCorta'=>"Gigabyte B450 AORUS ELITE, AMD, Presa AM4, AMD Ryzen, DDR4-SDRAM, DIMM, 2133,2400,2667,2933 MHz",
            ...
            'codCat'=>6,
            'descCorta'=>"Asus tuf x570-plus (wi-fi) scheda madre gaming amd x570 pcie 4.0, doppio m.2, wi-fi, 14 fasi di alimentazione dr. Mos, hdmi, dp, SATA 6gb/s, USB 3.2 gen 2 gen 2 e illuminazione rgb aura sync.",
            ...
            'codCat'=>7,
            'descCorta'=>"Le nuove CPU AMD Ryzen di terza generazione sono arrivate vantando maggiori miglioramenti delle prestazioni rispetto alla sua linea di predecessore. Con velocità più elevate, più memoria e larghezza di banda più ampia, le nuove CPU Ryzen cercano di migliorare e aggiornare il modo in cui ti rilassi, lavori e giochi.",
            ...
            'codCat'=>7,
            'descCorta'=>"La tecnologia Intel Turbo boost aumenta dinamicamente la frequenza del processore quando necessario sfruttando l'espansione termica e dell'alimentazione per accelerare la velocità quando ne hai bisogno, e un aumento dell'efficienza energetica quando non è necessario; l'idoneità per la piattaforma Intel vpro la tecnologia Intel vpro è un insieme di funzionalità di sicurezza e gestione sviluppate nel processore per affrontare quattro aree fondamentali.",
            ...
            'codCat'=>7,
            'descCorta'=>"Intel presenta la nuova famiglia di processori Intel Core per sistemi desktop di nona generazione, i primi processori per sistemi desktop mainstream sbloccati.",
            ...
            'codCat'=>7,
            'descCorta'=>"La memoria Intel Optane è una memoria non volatile che si trova tra la memoria di sistema e l'archiviazione per accelerare le prestazioni del sistema e la reattività. In combinazione con il Intel Rapid Storage Technology Driver, assicura che i dati utilizzati di frequente risiedano nel livello di archiviazione più veloce.",
            ...
            'codCat'=>5,
            'descCorta'=>"Gigabyte GV-N1660OC-6GD. Processore grafico: NVIDIA, Processore grafico: GeForce GTX 1660, Frequenza del processore: 1830 MHz. Memoria Grafica Dedicata: 6 GB, Tipo memoria adattatore grafico: GDDR5",
            ...
            'codCat'=>5,
            'descCorta'=>"MSI RTX 2070 Super Gaming X Trio. Processore grafico / fornitore: NVIDIA, Processore grafico: GeForce RTX 2070 SUPER. Memoria Grafica Dedicata: 8 GB",
            ...
            'codCat'=>5,
            'descCorta'=>"Memoria grafica dedicata: 8 GB - Memoria Video DDR6; Velocità max clock: 1830 MHz - Frequenza Memoria: 15500 MHz",
            ...
            'codCat'=>5,
            'descCorta'=>"MSI GeForce GTX 1050 Ti Gaming X 4G Scheda Grafica, Interfaccia PCIe 3.0, 4 GB GDDR5, 128bit, 768 Cuda Cores, Nero",
            ...
            'codCat'=>10,
            'descCorta'=>"Gli AirPods sono facilissimi da usare e ti danno un giorno intero di musica senza pensieri. Con gli AirPods Pro hai la cancellazione attiva del rumore e un comfort personalizzabile",
            ...
            'codCat'=>10,
            'descCorta'=>"Cancellazione attiva del rumore per immergerti nel suono. Modalità Trasparenza per sentire quello che hai intorno. Comfort su misura per ascoltare tutto il giorno. La magia ha un nuovo suono.",
            ...
            'codCat'=>9,
            'descCorta'=>"Il Gemini CDM-4000 CD Mixer Combo offre una console multimediale potente ed efficiente con un design intuitivo e facile da usare. I doppi deck per CD e la sezione mixer centrale offrono una soluzione flessibile all-in-one montabile su rack sia per DJ rack che per installazioni permanenti.",
            ...
            'codCat'=>9,
            'descCorta'=>"Pioneer XDJ-1000MK2. Connettore USB: USB Type-A, USB Type-B. Tipo alimentazione: AC. Tipo di display: LCD. Larghezza: 305 mm, Profondità: 382,5 mm, Altezza: 110 mm. Cavi inclusi: AC, Audio (3.5mm) , LAN (RJ-45)",
            'descLunga'=>"Basato sul suo predecessore, il modello XDJ-1000MK2 migliora la praticità d'uso attraverso il browsing potenziato dei brani e il supporto dei file audio ad alta risoluzione FLAC e ALAC. Eredita la grande jog wheel e lo schermo touch-screen a colori da 7 pollici del CDJ-2000NXS2 nonché funzioni quali 8 Hot Cues e Quantize. Scarica il software per la gestione della musica rekordbox o l'app rekordbox per preparare i set.",
            'prezzo'=>1325.00,
            'percSconto'=>0,
            'sconto'=>0,
            ...
            'codCat'=>8,
            'descCorta'=>"Pioneer ha combinato le funzioni popolari del DDJ-SB2 con le console di punta Serato DJ per un apprendimento più accessibile che mai per i disc jockey. Strumento ideale per i principianti che desiderano affinare le proprie abilità, questa console a 2 canali offre una facile navigazione con un layout di stile professionale ispirato alla gamma di prim'ordine DDJ-S",
            ...
            'codCat'=>8,
            'descCorta'=>"Grazie alle comode coppe auricolari, all'archetto imbottito e alla funzione Multipoint, con le cuffie senza fili JBL Tune500BT ti godi fino a 16 ore di divertimento musicale nel'ottimo del comfort e passi senza problemi da un dispositivo bluetooth a un altro",
            ...
            'codCat'=>8,
            'descCorta'=>"La cuffia per gaming Logitech G332 ti consente di sentire il gioco, con i driver da 50 mm che offrono una riproduzione audio ottima. Goditi tutti i tuoi giochi preferiti. Questa cuffia con microfono leggera, sottile e comoda è dotata di padiglioni in similpelle con rotazione a 90° e garantisce una compressione giusta per le tue lunghe sessioni di gioco",
            ...
            'codCat'=>8,
            'descCorta'=>"Nuove huawei freebuds lite vera esperienza senza fili. Sperimenta la migliore esperienza di ascolto grazie al suo design ispirato al mondo del golf",
            ...
            'codCat'=>11,
            'descCorta'=>"La mobilità e la flessibilità sono essenziali nel frenetico mondo degli affari di oggi. Il Philips Pocket Memo, registratore vocale fornisce la libertà di lavorare quando e dove vuoi. Il tono dell'indice di priorità indica i documenti urgenti",
            'descLunga'=>" Il tuo lavoro urgente può essere fatto prima. L'allarme suona per la fine del nastro e il livello di batteria basso, assicurando così che nessun dettato venga interrotto in modo indesiderato. Il tono indice alla fine della lettera indica l'inizio di ogni documento e il numero di registrazioni. Modifica facile e veloce dei file con il comodo interruttore a scorrimento. Questo ha una risposta rapida ed è stato progettato per funzionare con una sola mano. La funzione turbo-wind ti consente di saltare a qualsiasi sezione desiderata del nastro in pochi secondi. In questo modo è possibile risparmiare tempo prezioso. Il LED di stato indica un basso livello della batteria e lo stato di registrazione. L'allarme suona per la fine del nastro e il livello di batteria basso, assicurando così che nessun dettato venga interrotto in modo indesiderato. La registrazione a comando vocale è una comoda funzione per la dettatura a mani libere. Se è attivato, la registrazione inizierà automaticamente non appena inizi a parlare. La registrazione termina automaticamente dopo che hai smesso di parlare e si riavvia automaticamente quando inizi a parlare di nuovo. Quando il blocco del trasporto è attivato, il tuo dittafono è protetto contro il funzionamento involontario.",
            'prezzo'=>464.89,
            'percSconto'=>0,
            'sconto'=>0,
            ...
            'codCat'=>11,
            'descCorta'=>"Il dispositivo Voice Tracer 1000 è un registratore vocale perfetto per acquisire note, idee e pensieri ovunque. Grazie a 2 microfoni per la registrazione stereo, potrai acquisire la migliore qualità stereo.",
            'descLunga'=>"Compatto e leggero, il DVT 1000 assicura una registrazione stereo di eccellente qualità ed include un microfono specifico che permette di registrare le chiamate telefoniche. Dotato di una memoria di 2 GB, integra uno slot per scheda di memoria Micro SD. Facilissimo da utilizzare, è dotato inoltre di un supporto pieghevole che ne facilita il posizionamento durante la registrazione. Questo registratore digitale è in grado di restituire un suono stereo ad altissima qualità grazie all’integrazione di ben due microfoni, al pari dei migliori registratori professionali. E' possibile inoltre selezionare la funzione di attivazione vocale, che fa in modo che il registratore cominci a registratre quando incominciate a parlare.",
            'prezzo'=>118.08,
            'percSconto'=>0,
            'sconto'=>0,
            ...
            'codCat'=>11,
            'descCorta'=>"Il dispositivo New Majestic Micro è un registratore vocale perfetto per acquisire note, idee e pensieri ovunque. Grazie a 2 microfoni per la registrazione stereo, potrai acquisire la migliore qualità stereo.",
            ...
            'codCat'=>11,
            'descCorta'=>"Specifiche tecniche: Memoria: 8 GB-Con display LCD-Altoparlante incorporato funzione di riproduzione di musica indicazione di registrazione-Funzione di controllo sana disponibile-Built-in batteria al litio, ricaricabile",
            ...
            'image'=>'monodeal.jpg'],
             ...
             ['nome'=> 'CANON Kit Fotocamera EOS 2000D Kit + Obiettivo EF-S 18-55 IS',
            'codCat'=>12,
            'descCorta'=>"Muovi i primi passi nella fotografia reflex e inizia a raccontare le tue storie con la fotocamera EOS 2000D e l’obiettivo zoom compatto EF-S 18-55 mm IS II.",
            ...
            'image'=>'canon_2000d.jpg'],
             ['nome'=> 'CANON EOS 80D',
            'codCat'=>12,
            'descCorta'=>"Dotata di velocità straordinaria, controlli intuitivi e tecnologie innovative, questa versatile DSLR Wi-Fi è ideale per esplorare nuove aree in ambito fotografico e raggiungere risultati sorprendenti.",
            ...
            'codCat'=>12,
            'descCorta'=>"La carrozzeria Nikon D750 resistente alle intemperie è dotata di un sensore di formato FX rivisto che è molto sensibile alla luce. L'ISO è regolabile da 100 a 12800. Oltre alla sensibilità, la velocità è un elemento importante per ogni fotografo.",
            ...
            'codCat'=>12,
            'descCorta'=>"Stimolate il vostro spirito creativo con la sempre connessa D5600. La bellezza di un momento inaspettato. La perfetta ripresa time-Lapse, proprio come l'avevate immaginata. Non c'è nulla di più gratificante che creare qualcosa che sia apprezzato dagli altri, che si tratti di giochi d'ombra quando il sole è alto o filmati ripresi da angolazioni insolite.",
            ...
            'codCat'=>13,
            'descCorta'=>"Riprese incredibilmente stabili. Capacità di acquisizione intelligente. Robusta e impermeabile senza bisogno di custodia. Tutto questo è HERO7 Black: la GoPro più avanzata di sempre",
            ...
            'codCat'=>13,
            'descCorta'=>"Le videocamere GoPro HERO5 Black riuniscono il meglio della tecnologia esistente per raggiungere prestazioni mai immaginate prima.",
