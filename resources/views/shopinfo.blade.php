...
<div>
     <div class="infohead">
        <br><h1>Le nostre modalità d'acquisto</h1></br>
    </div>
    <div class="infotext">
    ...
    <div class="infocontainer">
        ...
        <section class="infobox">
            <h3>SPEDITO DA</h3>
            <div class="infobox1">
                <div class="infobox2"><img src="{{asset('images/courier/BRT.png')}}"></div>
                <div class="infobox2"><img src="{{asset('images/courier/Posteitaliane.png')}}"></div>
                <div class="infobox2"><img src="{{asset('images/courier/gls.png')}}"></div>
                <div class="infobox2"<img src="{{asset('images/courier/sda.png')}}"></div>
                <div class="infobox2"><img src="{{asset('images/courier/tnt.png')}}"></div>
            </div>
        </section>
        <section class="infobox">
