 ...
 <div id='containerPrivacyPolicy'>
    ...
    <div id="cookies" style="display: block;">
            ...
            <ul>
                    ...
                    <ul>
                            <li><b><span id="azienda">iPrice</span></b></li>
                            <li id="piva" style="display: block;">P. IVA <span id="iva">12345670157</span></li>
                    <li id="codiceFiscale" style="display: block;">Codice Fiscale: <span id="codice_Fiscale">00382520427</span></li>
                            <li><span id="indirizzo">Via Brecce Bianche, 12</span></li>
                            <li><span id="cap">60131</span> - <span id="citta">Ancona</span> (<span id="provincia">AN</span>)</li>
                            <li>Tel/Fax: <span id="telefono">3399957060</span></li>
                            <li>E-mail: <span id="email">iprice@info.it</span></li>
                    </ul>
