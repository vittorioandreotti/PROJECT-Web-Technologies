<div class="menuContainerAuth">
        <ul class="headerMenu">
          ...
          <li class="headerMenuItemAuth"><a href="{{route('manageproduct')}}">Gestisci prodotti</a></li>
          <li class="headerMenuItemAuth" id="newCategory"><a href="{{ route('insertCategory') }}" >Inserisci Categoria</a></li>
          <li class="headerMenuItemAuth" id="newSubCategory"><a href="{{ route('insertSubCategory') }}" >Inserisci Sottocategoria</a></li>
          @auth
